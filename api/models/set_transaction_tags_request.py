...
class SetTransactionTagsRequest(BaseModel):
    ...
    """ # noqa: E501
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="Map of tag names to values")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SetTransactionTagsRequest) in the input: " + _key)
