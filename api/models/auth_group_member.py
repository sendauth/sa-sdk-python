...
class AuthGroupMember(BaseModel):
    """
    AuthGroupMember
    """ # noqa: E501
    id: Optional[UUID] = Field(default=None, description="The unique identifier of the user")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in AuthGroupMember) in the input: " + _key)
