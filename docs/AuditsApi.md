...
------------- | ------------- | -------------
[**list_audits**](AuditsApi.md#list_audits) | **GET** /api/v1/audits | List audits


# **list_audits**
> PaginatedAudits list_audits(page=page, per_page=per_page, q=q)
...
with api.ApiClient(configuration) as api_client:
    ...
    api_instance = api.AuditsApi(api_client)
    ...
    try:
        # List audits
        api_response = api_instance.list_audits(page=page, per_page=per_page, q=q)
        print("The response of AuditsApi->list_audits:\n")
        pprint(api_response)
