...
class TagsApi:
    ...
    def _delete_tag_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/tags/{tagName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_tag_value(
        ...
        tag_name: StrictStr,
        tag_value: StrictStr,
        update_tag_value_request: UpdateTagValueRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type tag_value: str
        :param update_tag_value_request: (required)
        :type update_tag_value_request: UpdateTagValueRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_tag_value_serialize(
            tag_name=tag_name,
            tag_value=tag_value,
            update_tag_value_request=update_tag_value_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_tag_value_with_http_info(
        self,
        tag_name: StrictStr,
        tag_value: StrictStr,
        update_tag_value_request: UpdateTagValueRequest,
    ...
    @validate_call
    def update_tag_value_without_preload_content(
        self,
        tag_name: StrictStr,
        tag_value: StrictStr,
        update_tag_value_request: UpdateTagValueRequest,
    ...
    def _update_tag_value_serialize(
        self,
        tag_name,
        tag_value,
        update_tag_value_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_tag_value_request is not None:
            _body_params = update_tag_value_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/tags/{tagName}/values/{tagValue}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
