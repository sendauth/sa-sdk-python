...
class PermissionsApi:
    ...
    def _delete_permission_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/permissions/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def rename_permission(
        ...
        _param = self._rename_permission_serialize(
            name=name,
            permission=permission,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def rename_permission_with_http_info(
        self,
        name: StrictStr,
        permission: Permission,
        _request_timeout: Union[
    ...
    @validate_call
    def rename_permission_without_preload_content(
        self,
        name: StrictStr,
        permission: Permission,
        _request_timeout: Union[
    ...
    def _rename_permission_serialize(
        self,
        name,
        permission,
        _request_auth,
