...
class UpdateTagValueRequest(BaseModel):
    """
    UpdateTagValueRequest
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="New value for the tag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UpdateTagValueRequest) in the input: " + _key)
